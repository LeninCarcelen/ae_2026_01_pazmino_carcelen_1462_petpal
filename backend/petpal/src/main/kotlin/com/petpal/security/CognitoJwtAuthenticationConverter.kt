...
/**
 * Convierte el JWT de Cognito en un Authentication de Spring Security.
 * Cognito manda los grupos en el claim "cognito:groups" (ej. ["ROLE_ADMIN"]).
 * Los agregamos como authorities además de los scopes por defecto.
 */
@Component
